...
function listQ() {
  if (
    ...
    changedText.textContent =
      "Importe total de hipotecas de viviendas constituidas en cada provincia en miles de euros. Es importante tener en cuenta que se trata de el importe TOTAL, es decir la suma del importe de todas las hipotecas en cada mes y en cada provincia, y que sólo se incluyen las hipotecas de viviendas excluyéndose otro tipo de fincas. El INE ofrece datos mensuales para esta serie estadística. Podría utilizarse junto con el número total de hipotecas a través de una fuente de datos adicional en Tableau para calcular el importe medio. Requerirá limpiar la columna del ine 'Variable' para separar el nombre de la provincia.";
  }
}
